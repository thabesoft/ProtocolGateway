...
public sealed partial class RuntimeChannelViewModel : ViewModelBase
{
    ...
    // 标签
    private AvaloniaList<RuntimeTagViewModel> _tags = [];
    ...
    /// 端口
    /// </summary>
    public RuntimePortViewModel? Port
    {
    ...
    /// 标签
    /// </summary>
    public IReadOnlyCollection<RuntimeTagViewModel> Tags
    {
        get => _tags;
    ...
    {
        Tags = [.. configs.Select(RuntimeTagViewModel.CreateFromConfig)];
    }
    public void LoadPortConfig(IPortConfig config)
    {
        Port = RuntimePortViewModel.CreateFromConfig(config);
    }
