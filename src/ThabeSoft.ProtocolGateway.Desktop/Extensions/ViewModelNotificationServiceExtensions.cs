...
/// 视图模型通知业务扩展
/// </summary>
public static class ViewModelNotificationServiceExtensions
{
    ...
    extension<T>(T viewModel) where T : IViewModel
    {
        ...
        /// 是否可以通知
        /// </summary>
        public bool CanNotify => services.TryGetValue(viewModel, out _);
        ...
        {
            return viewModel.GetNotificationService()
