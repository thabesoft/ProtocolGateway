...
/// ModbusRtu 运行时通道
/// </summary>
internal static class RuntimeChannelExtensions
{
    extension(RuntimeChannel)
    {
        /// <summary>
        /// 创建Modbus通道
        /// </summary>
        public static Result<IRuntimeChannel> CreateModbus(IChannelConfig config)
        {
            ...
            // 运行时
            var runtime = new RuntimeChannel(config, channel.StartAsync, channel.StopAsync, channel.DisposeAsync);
