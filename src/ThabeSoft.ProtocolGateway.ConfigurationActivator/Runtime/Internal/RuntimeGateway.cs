...
/// 运行时网关
/// </summary>
internal sealed class RuntimeGateway(IRuntimeChannelFactory factory) : StartableObject, IRuntimeGateway, IAsyncDisposable
{
    ...
    /// 启动网关
    /// </summary>
    protected override async ValueTask<Result> StartAsync(CancellationToken cancellationToken)
    {
    ...
    /// 停止网关
    /// </summary>
    protected override async ValueTask<Result> StopAsync(CancellationToken cancellationToken)
    {
        List<string> error_message = [];
