...
//            {
//                if (!i.IsSuccess) return Result.Error(i.Message!);
//            }
...
//        public static Result Error(string message = "无效操作")
//        {
...
//        /// </remarks>
//        /// <param name="message">具体的错误描述</param>
//        public static Result<T> Error<T>(string message = "无效操作")
//        {
...
//        /// </remarks>
//        /// <param name="message">具体的错误描述</param>
//        public static Result Error(string message = "无效参数")
//        {
//            return Result.Error( message);
//        }
//        /// <summary>
...
//        /// </remarks>
//        /// <param name="message">具体的错误描述</param>
//        public static Result<T> Error<T>(string message = "无效参数")
//        {
//            return Result.Error<T>( message);
//        }
...
//        /// </remarks>
//        public static Result Error(string message = "无效数据")
//        {
//            return Result.Error( message);
//        }
//        /// <summary>
...
//        /// <para>这是设备或数据源的问题，不是调用方的问题。</para>
//        /// </remarks>
//        public static Result<T> Error<T>(string message = "无效数据")
//        {
//            return Result.Error<T>( message);
//        }
...
//        public static Result Error(string message = "不支持")
//        {
...
//        /// <returns>包含不支持错误的 Result&lt;T&gt;</returns>
//        public static Result<T> Error<T>(string message = "不支持")
//        {
...
//        public static Result Error(string message = "超时")
//        {
...
//        /// <param name="message">具体的错误描述，默认为"超时"</param>
//        /// <returns>包含超时错误的 Result&lt;T&gt;</returns>
//        public static Result<T> Error<T>(string message = "超时")
//        {
...
//        public static Result Error(string message = "已取消")
//        {
...
//        /// <param name="message">具体的错误描述，默认为"已取消"</param>
//        /// <returns>包含取消错误的 Result</returns>
//        public static Result<T> Error<T>(string message = "已取消")
//        {
...
//        public static Result Error(string message = "内部错误")
//        {
//            return Result.Error(ErrorType.Cancelled, message);
//        }
//        /// <summary>
...
//        /// <param name="message">具体的错误描述，默认为"内部错误"</param>
//        /// <returns>包含内部错误的 Result</returns>
//        public static Result<T> Error<T>(string message = "内部错误")
//        {
//            return Result.Error<T>(ErrorType.Cancelled, message);
//        }
//    }
