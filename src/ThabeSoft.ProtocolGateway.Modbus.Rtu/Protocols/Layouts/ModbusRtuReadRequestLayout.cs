...
/// Modbus Rtu 读请求布局
/// </summary>
public readonly struct ModbusRtuReadRequestLayout : IModbusReadRequestLayout, IModbusRtuLayoutExtension
{
    public static ModbusRtuReadRequestLayout Instance => default;
