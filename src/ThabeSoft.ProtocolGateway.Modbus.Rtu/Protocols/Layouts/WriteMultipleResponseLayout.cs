...
/// 写多值响应布局
/// </summary>
public readonly record struct WriteMultipleResponseLayout
{
    public static WriteMultipleResponseLayout Instance => default;
    ...
    {
        return $"总长度={TotalLength}, Id({SlaveIdIndex})Func({FunctionCodeIndex})Address({AddrassRange})Quantity({QuantityRange})Crc({CrcRange})";
    }
}