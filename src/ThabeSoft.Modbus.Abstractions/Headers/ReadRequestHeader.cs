...
public readonly record struct ReadRequestHeader
{
    ...
    {
        if (functionCode.IsReadCoils) return Result.Error<ReadRequestHeader>("无效功能码");
        return Result.Success(new ReadRequestHeader(slaveId, functionCode, address, quantity));
    }
    public static Result<ReadRequestHeader> AnyCoils(byte slaveId, FunctionCode functionCode, ushort address, int quantity)
    {
        ...
        if (!quantity_result.IsSuccess) return quantity_result.Cast<ReadRequestHeader>();
    ...
    {
        if (functionCode.IsReadRegisters) return Result.Error<ReadRequestHeader>("无效功能码");
        return Result.Success(new ReadRequestHeader(slaveId, functionCode, address, quantity));
    }
    ...
    public static Result<ReadRequestHeader> Coils(byte slaveId, ushort address, int quantity)
    {
        ...
        return Result.Success(new ReadRequestHeader(slaveId, FunctionCode.ReadCoils, address, quantity_result.Value));
    }
    ...
    public static Result<ReadRequestHeader> DiscreteInputs(byte slaveId, ushort address, int quantity)
    {
        ...
        return Result.Success(new ReadRequestHeader(slaveId, FunctionCode.ReadDiscreteInputs, address, quantity_result.Value));
    }
    ...
    public static Result<ReadRequestHeader> HoldingRegisters(byte slaveId, ushort address, int quantity)
    {
        ...
        return Result.Success(new ReadRequestHeader(slaveId, FunctionCode.ReadHoldingRegisters, address, quantity_result.Value));
    }
    ...
    public static Result<ReadRequestHeader> InputRegisters(byte slaveId, ushort address, int quantity)
    {
        ...
        return Result.Success(new ReadRequestHeader(slaveId, FunctionCode.ReadInputRegisters, address, quantity_result.Value));
    }
