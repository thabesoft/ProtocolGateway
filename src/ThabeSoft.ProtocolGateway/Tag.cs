    ...
    where TValue : unmanaged
{
    ...
    internal Tag(IAddress address, DataType type, int length, IValueConverter<TValue> converter)
    {
        Address = address;
        ValueType = type;
        Length = length;
    ...
    where TValue : unmanaged
{
    ...
    internal RoutableTag(ChannelName name, IAddress address, DataType type, int length, IValueConverter<TValue> converter)
    {
        ChannelName = name;
        Address = address;
        ValueType = type;
